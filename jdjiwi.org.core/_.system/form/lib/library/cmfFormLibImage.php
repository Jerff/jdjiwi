...
function cmfImageResize($image, $width, $height) {
    ...
    imagecopyresampled($image_out, $image_in, 0, 0, 0, 0, $width, $height, $img_x, $img_y);
...
function cmfImageResize2($image, $width, $height) {
    ...
    imagecopyresampled($image_out, $image_in, $new_left, $new_top, 0, 0, $new_width, $new_height, $img_x, $img_y);
    imagedestroy($image_in);
